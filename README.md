...
Statistical Analysis (ANOVA): Applied a one-way ANOVA test to evaluate whether the differences in social media engagement across various age groups were statistically significant.

Machine Learning: Utilised K-Means clustering (supported by the Elbow method) to segment campaign performance based on Ad Spend and ROI.

Key Findings & Business Insights

Platform Preferences: The initial hypothesis—that middle-aged users (40-55) prefer Facebook while younger users (30-40) prefer Instagram—was not supported by the data. Platform usage distribution was remarkably uniform across all age segments.

Purchasing Behaviour: Customer purchasing frequency and average order value remained consistent, showing no significant variation based on marketing channels or demographics.
